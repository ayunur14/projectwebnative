...
if (isset($_POST['button'])) {
    ...
    $query = "INSERT INTO accountt(id_account, email, password, akses) VALUES ('', '$email', MD5('$pw'), '2')";

    if (mysqli_query($conn, $query)) {
        $id = mysqli_insert_id($conn);
        $data = mysqli_query($conn, "INSERT INTO tbl_users(id_user, id_account, nama, telepon, tempatlahir, tgl_lahir, jk, alamat) VALUES ('', '$id', '$nama', '$telepon', '$tempat', '$tgl', '$jk', '$alamat')");
